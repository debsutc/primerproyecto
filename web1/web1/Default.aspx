<%@ Page Title="Página principal" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="web1._Default" %>
...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    <section class="featured">
        <div class="content-wrapper">
            <hgroup class="title">
                <h1><%: Title %>.</h1>
                <h2>Modifiqu esta plantilla para poner en marcha su aplicación ASP.NET.</h2>
            </hgroup>
            <p>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <ol class="round">
        ...
        <li class="two">
            <h5>Agregar paquetes NuGet y poner e&nbsp;&nbsp;&nbsp; n marcha su codificación</h5>
